...
public class TestRegister {
	...
	public void testPlaceholders() throws InterruptedException {
		...
		String placeholder5 = driver.findElement(By.xpath("(//input[@type='password'])[2]")).getAttribute("placeholder");
	...
	public void testEqualWidth() throws InterruptedException {
		...
		driver.findElement(By.linkText("Register")).click();
		Thread.sleep(1000);
		String width1 = driver.findElement(By.xpath("(//input[@type='password'])[2]")).getCssValue("width");
